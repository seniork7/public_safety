                            ...
                            <div className="lg:col-span-2">
                                <div className="flex items-center gap-4 mb-4">
                                    <div>
                                        ...
                                        <p className="mt-1">{alert.alertText}</p>
                                    </div>
                                </div>

                                <p className="max-w-3xl mb-6">{alert.summary}</p>
                                ...
                                <Link to="/"
                                    className="flex items-center gap-2 mt-10 font-semibold text-accent-secondary hover:text-surface  cursor-pointer transition duration-700 hover:scale-98"
                        ...
                        <div className="p-4 space-y-4 flex-1">
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <button onClick={handleCopy} title="Copy link" className="flex-1 bg-bg border border-border text-text-primary py-2 rounded-lg hover:bg-surface hover:text-accent-primary hover:scale-95 transition duration-700 cursor-pointer">
                                        <HiClipboardCopy className="inline-block mr-2" />
                                        {copied ? "Copied!" : "Copy Link"}
                                    </button>
                                    <button onClick={handleShare} title="Share tip" className="flex-1 bg-accent-primary text-surface hover:text-text-primary hover:scale-95 py-2 rounded-lg hover:bg-accent-secondary transition duration-700 cursor-pointer">
